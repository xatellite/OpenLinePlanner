<template>
  <GondolaIcon v-if="type === 'gondola'" />
  <BusIcon v-if="type === 'bus'" />
  <TramIcon v-if="type === 'tram'" />
  <SubwayIcon v-if="type === 'subway'" />
  <TrainIcon v-if="type === 'train'" />
  <TuneVariantIcon v-if="type === 'custom'" />
</template>
